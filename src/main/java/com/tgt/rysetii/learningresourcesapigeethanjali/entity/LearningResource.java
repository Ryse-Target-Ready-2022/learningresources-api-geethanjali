package com.tgt.rysetii.learningresourcesapigeethanjali.entity;
...
public class LearningResource
{
    ...
    public LearningResource(Integer learningResourceId, String productName, Double costPrice, Double sellingPrice, LearningResourceStatus productStatus, LocalDate createdDate, LocalDate publishedDate, LocalDate retiredDate)
    {
